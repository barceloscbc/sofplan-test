...
public class GeradorObservacaoTest {
	...
	@Test
	public void geraObservacaoVaziaQuandoNaoExistemALista() {
		String observacaoGerada = this.geradorObservacao.geraObservacao(null);
		assertTrue(observacaoGerada.isEmpty());
	}

	@Test
	public void geraObservacaoVaziaQuandoNaoExistemNotas() {
		String observacaoGerada = this.geradorObservacao.geraObservacao(Collections.<Integer>emptyList());
		assertTrue(observacaoGerada.isEmpty());
	}
